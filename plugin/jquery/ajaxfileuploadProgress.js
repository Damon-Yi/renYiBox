jQuery.extend({
	...
	ajaxFileUpload : function(s) {
		...
		var fd = new FormData();
		var fileElementIds = s.fileElementIds;
	//	console.log("fileElementIds :"+fileElementIds);
	//	console.log(document.getElementById(fileElementIds));
	//	return null;
		fd.append(fileElementIds, document.getElementById(fileElementIds).files[0]);
